...
const Footer = () => {
    return ( 
        <footer className="flex flex-col items-start justify-between min-h-[50vh] w-full sm:px-10 sm:py-5 lg:px-20 lg:py-10 p-5 text-white bg-gray-900">
            <img src="./assets/Transcend_White.png" alt="" className="w-[200px]" />
            <div className="flex flex-col items-center justify-center lg:flex-row w-full py-5">
                <div className="p-10 flex flex-col items-center text-center text-white lg:items-start justify-around">
                    ...
                    <span className="text-sm sm:text-base lg:text-base font-bold flex items-center justify-center"><i className='bx bx-current-location mx-5 text-lg'></i>No 3 Indus Close, Maitama, Abuja</span>
                    <a href="mailto:contact@transcendstudy.ng" className="text-sm sm:text-base lg:text-base font-bold flex items-center justify-center"><i className='bx bxs-envelope mx-5 text-lg'></i>contact@transcendstudy.ng</a>
                    <a href="tel:+2348188460781" className="text-sm sm:text-base lg:text-base font-bold flex items-center justify-center"><i className='bx bxs-phone-call mx-5 text-lg'></i>+2348188460781</a>
                </div>

                <div className="p-5 sm:p-10 lg:mx-5 flex flex-col items-center lg:items-start justify-around">
